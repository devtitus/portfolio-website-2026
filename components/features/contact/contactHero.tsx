...
const ContactHero: React.FC = () => {
  return (
    <section className="relative px-[clamp(16px,4vw,60px)] pt-[100px] pb-[40px] max-w-[1400px] mx-auto xl:px-0 z-10">
      {/* Decorative background */}
      <div
        className="absolute -top-[20%] left-0 w-full h-[150%] pointer-events-none -z-10"
      />
