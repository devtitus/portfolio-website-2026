...
### 2. Navbar (`components/layouts/navbar.tsx`)
...
### 3. CommandMenu (`components/layouts/command-menu.tsx`)
...
### 1. Home (`app/(routes)/(home)/page.tsx`)
...
### 2. HeroSection (`components/features/hero/heroSection.tsx`)
...
### 3. About (`app/(routes)/about/page.tsx`)
**Purpose**: About page component
**Type**: Client Component
**Status**: In development

### 4. Projects (`app/(routes)/projects/page.tsx`)
**Purpose**: Portfolio showcase
**Type**: Client Component
**Status**: In development

### 5. Contact (`app/(routes)/contact/page.tsx`)
...
### 1. AuroraText (`components/ui/magicui/aurora-text.tsx`)
...
### 2. InfiniteMovingCards (`components/ui/infinite-moving-cards.tsx`)
...
### 1. SkillCard (`components/features/hero/skillCard.tsx`)
...
### 2. ProjectCard (`components/features/hero/projectCard.tsx`)
...
### 3. ContactSection (`components/features/hero/contactSection.tsx`)
...
### 4. FobSection (`components/features/hero/fobSection.tsx`)
**Purpose**: Footer/Bottom section
**Type**: Client Component
**Key Features**:
- Footer content
- Social links
...
### 1. Footer (`components/layouts/footer.tsx`)
**Purpose**: Site footer layout
**Type**: Client Component
**Key Features**:
- Social media links
- Copyright information
...
- `styles/features/home/hero.module.css`
- `styles/features/home/skill.module.css`
- `styles/features/home/project.module.css`
- `styles/features/home/contact.module.css`
- `styles/features/home/fob.module.css`
- `styles/features/home/test.module.css`

### Layout Styles
- `styles/layouts/navbar.module.css`
...
- Type definitions: `lib/types/sanity.ts`
- Service functions: `lib/services/sanity/`
- Data fetching: `lib/services/sanity/getSiteSettings.ts`

### Query Functions
- `getSiteSettings.ts` - Site configuration data
- `getSkills.ts` - Skills and technologies data
- `getTestimonials.ts` - Customer testimonials data
