...
The following paths may exist in legacy documentation or external references:
- `app/components/navbar/` → `components/layouts/`
- `app/components/command-menu/` → `components/layouts/`
- `app/utils/` → `lib/utils/`
- `app/queries/` → `lib/services/`
...
- [ ] Command menu (⌘K) opens and functions
